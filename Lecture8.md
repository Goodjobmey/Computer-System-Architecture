...
2. **Простота реализации**. Эта архитекутра проста с точки зрения реализации, и у нее очень простой машинный код. 
...
>[!todo] что тут вообще писать, если в лекции объясняется не фон-Неймана, а гарвардская????
