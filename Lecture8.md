...
Здесь применена сложная инструкция, которая сразу вычисляет линейную функцию в рамках одной команды. Такой подход характерен для специализированных процессоров, где известно, что необходимо выполнять множество однотипных линейных функций. Реализация подобных операций на уровне аппаратуры процессора даёт ряд преимуществ. 
