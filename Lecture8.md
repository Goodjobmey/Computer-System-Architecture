...
Рассмотрим более [конкретную организацию](http://amazing-new-gate.blogspot.com/2010/07/haskell.html) архитектуры фон Неймана:
...
Одним из ключевых факторов, способствовавших развитию архитектуры CISC, стало внедрение микропрограммного управления. Оно позволило реализовывать сложные команды и расширенные режимы адресации без существенных затрат на аппаратную часть. Благодаря микропрограммам появилась возможность создавать универсальные и мощные инструкции, включая сложные арифметические операции и потоковые обработки данных, а также обеспечивать поддержку разнообразных режимов адресации для всех типов команд. Кроме того, микропрограммное управление дало возможность обновлять и оптимизировать работу процессора даже после его выпуска путём изменения микрокода, как это было реализовано, например, в системах семейства УВК «Самсон» для РВСН.
