...
В проектировании CISC-процессоров особое внимание следует уделять устройству процессора и блока управления (**Control Unit**), так как реализация конечного автомата, генерирующего все многообразие инструкций, представляет собой серьёзную техническую задачу.
